...
Class Joueur extends User
{
    ...
    public function __construct($id_user, $nom_user, $prenom_user, $mdp_user, $phone_user, $adresse_user, $cd_postale_user, $nombre_points)
    {
   ...
   {
        $LesGrillesduJoueur::append($grille);
   }
